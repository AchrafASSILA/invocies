			...
			<div class="card-header pb-0">
				<div class="d-flex justify-content-between">
					<h4 class="card-title mg-b-0"><a style="padding: 10px;border-radius: 2px;
						...
						color: white;
						display: flex;
						justify-content: center;" href="{{route('sections.create')}}">اضف قسم</a>
				   </h4>
						...
						<tbody>
							...
							<tr>
								...
								<form style="display: inline-block;" action="{{route('sections.destroy',$section->id)}}" method="post">
									...
									background: #e43b6d;
									color: white;
									border-radius: 5px;height:27px;border: none;width:38.97px" onclick = "return confirm('هل تريد حذف هذا القسم ؟')" type="submit"  >
										حذف
									</button>
								  </form>	
							</td>
